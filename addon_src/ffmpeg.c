 ...
 */
 ...
 void ffmpeg_cleanup(int ret)
 {
    ...
    // Reset global counters for next run
    nb_input_files = 0;
    nb_output_files = 0;
    nb_filtergraphs = 0;
    nb_decoders = 0;
 ...
 napi_value ffmpeg_run(napi_env env, napi_callback_info info)
 {
    ...
    // Allocate memory to store string arguments
    // Need extra space for "ffmpeg" program name
    ...
    // Memory to store string content (needs to persist)
    ...
    // Extract string arguments from JavaScript array
